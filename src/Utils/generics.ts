...
export const generateMessageIDV2 = (userId?: string): string => {
	...
	return  'TWILIGHT-OF-RONIN' + hash.toString('hex').toUpperCase().substring(0, 18)
	// return '3EB0' + hash.toString('hex').toUpperCase().substring(0, 18)
}

// generate a random ID to attach to a message
export const generateMessageID = () => 'TWILIGHT-OF-RONIN' + randomBytes(18).toString('hex').toUpperCase()
